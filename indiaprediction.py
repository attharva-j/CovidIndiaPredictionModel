...
print("Confirmed case prediction count for 15-05-2020: " + str(int(lin_reg2.predict(poly_reg.fit_transform([[107]]))[0][0])))
...
plt.title('Salary Prediction(Polynomial Reg.)')
plt.xlabel('Position level')
plt.ylabel('Salary')
plt.show()
